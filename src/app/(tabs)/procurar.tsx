...
export default function ListaPlantas() {
  ...
  // useEffect para buscar as plantas guardadas localmente
  useEffect(() => {
  ...
  // Função para adicionar uma planta às guardadas
  ...
  // Função para remover uma planta das guardadas
  ...
  useEffect(() => {
    ...
    const resultados = plantas.filter(
      (planta) =>
